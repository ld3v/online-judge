...
class Assignment_model extends CI_Model
{
	...
	public function third_party_assignments()
	{
		$assignments = $this->db->order_by('id')->get('assignments')->result_array();
		foreach ($assignments as &$assignment)
		{
			$assignment['problems'] = $this->all_problems_array($assignment["id"]);
		}
		return $assignments;
	}
	...
	public function all_problems_array($assignment_id)
	{
		return $this->db->from('problems')
					->join('problem_assignment', 'problems.id = problem_assignment.problem_id')
					->where('problem_assignment.assignment_id', $assignment_id)
					->order_by('ordering')
					->get()
